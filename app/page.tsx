      ...
      <div className="relative max-w-6xl mx-auto pt-24 sm:pt-48 p-4 sm:p-8">
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-8 prose prose-lg max-w-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
            ...
            {/* Junk's Adventures */}
            <div className="bg-white rounded-lg shadow-md transition-shadow p-4 sm:p-6 border-2 border-gray-100 opacity-75">
            ...
            {/* A Coding Adventure */}
            <div className="bg-white rounded-lg shadow-md transition-shadow p-4 sm:p-6 border-2 border-gray-100 opacity-75">
              <h2 className="text-lg sm:text-xl font-semibold mb-2">A Coding Adventure</h2>
              <div className="space-y-1 sm:space-y-2 mb-3 sm:mb-4">
              ...
              <p className="text-gray-600 mb-3 sm:mb-4">Learn to code with Mr. Fluffbutt as your guide!</p>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Coming Soon</span>
                <span className="px-2 sm:px-3 py-1 text-sm bg-gray-100 text-gray-800 rounded-full">Stay Tuned!</span>
              </div>
